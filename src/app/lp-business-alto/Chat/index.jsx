...
export default function Chat() {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 sm:bottom-6 sm:right-6">
      <span className="absolute -inset-1 rounded-full bg-emerald-400/35 blur-md" />
      <a
        href={whatsappLink}
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Falar no WhatsApp"
        className="group relative flex items-center gap-2 rounded-full bg-[#25D366] px-3 py-2.5 shadow-lg transition hover:scale-[1.02] hover:bg-[#20bd5a]"
      >
