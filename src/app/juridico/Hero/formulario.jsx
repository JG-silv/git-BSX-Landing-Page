...
const FormSection = () => {
  ...
  // Data alvo: 10 de Fevereiro do ano atual (ou próximo) às 23:59:59
  // Nota: Ajuste o ano conforme a necessidade (ex: 2025, 2026)
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      if (distance < 0) {
        // Se o tempo acabou, paramos o cronômetro
        clearInterval(interval);
        setTimeLeft({ days: 0, hours: 0, minutes: 0, seconds: 0 });
      } else {
        // Cálculo matemático para dias, horas, minutos e segundos
        setTimeLeft({
